  ...
  for (int i = 0; i < n_mics; i++ ) {
    ...
    */
    ...
    if (anger[i] > 200) {
      ...
      strip.setLEDcolorPWM(5-2*i, anger*4-600, anger[i], 0);
      strip.setLEDcolorPWM(7+2*i, anger*4-600, anger[i], 0);
      //delay (100);
      strip.setLEDcolorPWM(4-2*i, anger*4-600, anger[i], 0);
      strip.setLEDcolorPWM(6+2*i, anger*4-600, anger[i], 0);
    }
    else if (anger[i] > 100) {
